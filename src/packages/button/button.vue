<template>
  <button class="y-button" :class="btnClass" :disabled="loading" @click="$emit('click', $event)">
    <y-icon :icon="icon" v-if="icon && !loading" class="icon"></y-icon>
    <y-icon icon="loading" v-if="loading" class="icon"></y-icon>
